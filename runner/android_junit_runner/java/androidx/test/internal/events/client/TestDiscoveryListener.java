...
public final class TestDiscoveryListener extends RunListener {
  ...
  public void testFailure(Failure failure) {
    // this is likely a JUnit error loading the class aka a
    try {
  ...
  public void reportProcessCrash(Throwable t) {
    ...
    testRunStarted(Description.EMPTY);
    testFailure(new Failure(Description.EMPTY, t));
    // report run finished, since process crashed, we are likely dying
    testRunFinished(new Result());
  }
}
